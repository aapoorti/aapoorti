          ...
          body: Container(
            child: Column(
              children: <Widget>[
                ...
                Expanded(child: jsonResult == null ? SpinKitFadingCircle(color: AapoortiConstants.primary, size: 120.0) : jsonResult.toString().isEmpty ? Center(child: Text("Data not found")) : _myListView(context),
                ),
              ],
            ),
          ),
