...
class CrcSummaryDataScreen extends StatefulWidget {
  ...
  CrcSummaryDataScreen(this.fromdate, this.todate, this.rlyname, this.rlycode, this.unittypename, this.unittypecode,
  ...
  @override
  State<CrcSummaryDataScreen> createState() => _CrcSummaryDataScreenState();
}

class _CrcSummaryDataScreenState extends State<CrcSummaryDataScreen> with SingleTickerProviderStateMixin{
