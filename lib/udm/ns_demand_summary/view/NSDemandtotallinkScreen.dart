...
import '../providers/change_nsdscroll_visibility_provider.dart';

class NSDemandtotallinkScreen extends StatefulWidget {
  final String? orgZone;
  ...
  final String? toDate;
  NSDemandtotallinkScreen(this.orgZone, this.unitType, this.unitName, this.department, this.indentorPostId, this.consigneecode, this.indentorName, this.total, this.draft, this.underFinanceConcurrence, this.underFinanceVetting, this.underProcess,
      this.approvedForwardPurchase, this.returnedByPurchase, this.dropped, this.frmDate, this.toDate);

  @override
  State<NSDemandtotallinkScreen> createState() => _NSDemandtotallinkScreenState();
}

class _NSDemandtotallinkScreenState extends State<NSDemandtotallinkScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      Provider.of<NSDemandSummaryViewModel>(context, listen: false).getNSDemandTotallinkData(
          widget.orgZone, widget.unitType, widget.unitName, widget.department, widget.indentorPostId, widget.consigneecode,
          widget.indentorName, widget.total, widget.draft, widget.underFinanceConcurrence, widget.underFinanceVetting,
          widget.underProcess, widget.approvedForwardPurchase, widget.returnedByPurchase, widget.dropped, widget.frmDate,
          widget.toDate, context);
    });
  }
                  ...
                  return Container(
                    ...
                    child: Center(
                      child: TextField(
                        ...
                        onChanged: (query) {
                          Provider.of<NSDemandSummaryViewModel>(context, listen: false).searchingNSDMDtotallink(query, context);
                        },
                      ),
                    ),
                  );
          ...
          child: Column(
            ...
            children: [
              Expanded(child: Consumer<NSDemandSummaryViewModel>(
                  builder: (context, value, child) {
                    if(value.nstotallinkDataState == NSDemandDatatotallinkState.Busy) {
                    ...
                    else if(value.nstotallinkDataState == NSDemandDatatotallinkState.Finished) {
                      return ListView.builder(
                          itemCount: value.nstotallinklistData.length,
                          shrinkWrap: true,
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 4.0),
                                                    Text("${value.nstotallinklistData[index].dmdno.toString()} Dt. ${DateFormat('dd-MM-yyyy').format(DateTime.parse(value.nstotallinklistData[index].dmddate.toString()))}",
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 4.0),
                                                    Text(
                                                        "${value.nstotallinklistData[index].indentorname.toString().split("<br/>")[0]}\n${value.nstotallinklistData[index].indentorname.toString().split("<br/>")[1]}",
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontWeight:
                                                            FontWeight.w400,
                                                  ...
                                                  children: [
                                                    Text(
                                                        ...
                                                        style: TextStyle(
                                                            ...
                                                            FontWeight.w500)),
                                                    SizedBox(height: 4.0),
                                                    value.nstotallinklistData[index].itemDescription == null ? Text("NA", style: TextStyle(
                                                        color: Colors.black,
                                                        fontSize: 16)) : ReadMoreText(
                                                      removeHtmlTags(value.nstotallinklistData[index].itemDescription!) ?? "NA",
                                                      style: TextStyle(
                                                          color: Colors.black,
                                                          fontSize: 16),
                                                      trimLines: 3,
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 4.0),
                                                    Text(
                                                        "Rs. ${value.nstotallinklistData[index].demandestval.toString()}/${value.nstotallinklistData[index].approvalvalue.toString().trim()}",
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontWeight:
                                                            FontWeight.w400,
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 4.0),
                                                    value.nstotallinklistData[index].purchageunit == null ? Text("NA", style: TextStyle(color: Colors.black, fontSize: 16)) : Text("${value.nstotallinklistData[index].purchageunit.toString()}", style: TextStyle(color: Colors.black, fontSize: 16))
                                                    //Text("P.O.No. ${value.coveredDueData[index].poNo.toString()} dt. ${value.coveredDueData[index].podt.toString()} on M/s. ${value.coveredDueData[index].firm.toString()} PO-CAT:[ XX ]", style: TextStyle(color: Colors.black, fontSize: 16))
                                                  ],
                                                ),
                                                SizedBox(height: 10),
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 4.0),
                                                    Text(value.nstotallinklistData[index].dmdstatus == "2" ? "Purchase Unit: ${value.nstotallinklistData[index].currentlywith.toString()}" : "${value.nstotallinklistData[index].username.toString()}\n${value.nstotallinklistData[index].currentlywith.toString()}\n${value.nstotallinklistData[index].useremail.toString()}", style: TextStyle(color: Colors.black, fontSize: 16)),
                                                  ],
                                                ),
                                                SizedBox(height: 10),
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                        ...
                                                        style: TextStyle(
                                                            ...
                                                            fontWeight: FontWeight.w500)),
                                                    SizedBox(height: 4.0),
                                                    Text("${value.nstotallinklistData[index].dmdstatusval.toString()}", style: TextStyle(color: Colors.black, fontSize: 16))
                                                  ],
                                                ),
                                                SizedBox(height: 15),
                                                // Row(
                    ...
                    else if(value.nstotallinkDataState == NSDemandDatatotallinkState.NoData) {
                      return Center(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    else if(value.nstotallinkDataState == NSDemandDatatotallinkState.FinishedWithError) {
                      return Center(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          mainAxisAlignment: MainAxisAlignment.center,
