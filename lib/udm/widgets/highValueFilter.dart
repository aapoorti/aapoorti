...
class HighValueFilter extends StatefulWidget {
  ...
  @override
  State<HighValueFilter> createState() => _HighValueFilterState();
}

class _HighValueFilterState extends State<HighValueFilter> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
            Provider.of<LanguageProvider>(context).text('highValueItems'),
              ...
              _buildSectionCard(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'High Value Items (as per Stock Value)',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ),
                    ...
                    child: _buildPrimaryButton(
                      ...
                      onPressed: () {
                        ...
                        if(userDepotName.toString() == "All" || userDepotCode.toString() == "-1" || userDepotName == null) {
                          itemListProvider = Provider.of<HighValueProvider>(context, listen: false);
                          ...
                          Navigator.of(context).pushNamed(HighValueScreen.routeName, arguments: [railwayCode,
                            unittypeCode,
                            unitnameCode,
                            deptCode,
                            userDepotCode,
