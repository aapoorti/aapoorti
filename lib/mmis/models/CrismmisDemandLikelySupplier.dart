class CrismmisDemandLikelySupplier {
  String? apiName;
  String? keyVer;
  String? status;
  String? dataCount;
  ...
  String? instructions;
  List<LikelySupplierData>? data;

  CrismmisDemandLikelySupplier(
      {this.apiName,
        this.keyVer,
        this.status,
        this.dataCount,
  ...
  CrismmisDemandLikelySupplier.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <LikelySupplierData>[];
      json['data'].forEach((v) {
        data!.add(new LikelySupplierData.fromJson(v));
      });
    }
  }
...
class LikelySupplierData {
  ...
  LikelySupplierData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    key1 = json['key1'];
    key2 = json['key2'];
    key3 = json['key3'];
