class CrismmisDemandItemCon {
  ...
  String? instructions;
  List<ItemConData>? data;

  CrismmisDemandItemCon(
      {this.apiName,
        this.keyVer,
        this.status,
        this.dataCount,
  ...
  CrismmisDemandItemCon.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <ItemConData>[];
      json['data'].forEach((v) {
        data!.add(new ItemConData.fromJson(v));
      });
    }
  }
...
class ItemConData {
  ...
  ItemConData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    key1 = json['key1'];
    key2 = json['key2'];
    key3 = json['key3'];
