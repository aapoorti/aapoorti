class DemandActionUser {
  ...
  DemandActionUser.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <ActionUser>[];
      json['data'].forEach((v) {
        data!.add(new ActionUser.fromJson(v));
      });
    }
  }
...
class ActionUser {
  ...
  ActionUser.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    key1 = json['key1'];
    key2 = json['key2'];
    key3 = json['key3'];
