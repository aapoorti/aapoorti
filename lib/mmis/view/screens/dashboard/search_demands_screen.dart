...
class _SearchDemandsScreenState extends State<SearchDemandsScreen> {
  ...
  String selectedDemand = "New CRIS MMIS";
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: CustomSelectionContainer(
                        title: "Old CRIS MMIS",
                        isSelected: selectedDemand == "Old CRIS MMIS",
                      ),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: CustomSelectionContainer(
                        title: "New CRIS MMIS",
                        isSelected: selectedDemand == "New CRIS MMIS",
                      ),
                    ),
                  ],
                ),
                 ...
                 ElevatedButton(
                  onPressed: () {
                     if(selectedDemand == "New CRIS MMIS" && _demandnumController.text.length == 0){
                       if(fromDate != 'from' && toDate != 'to' && selectedstatus != "All" && selectedDepart != "All"){
                         ...
                         Get.toNamed(Routes.searchDemandsDataScreen, arguments: ['N', fromDate, toDate, "-99", statusCode, "-1", '98', '05']);
                       }
                       else if(fromDate != 'from' && toDate != 'to' && selectedstatus == "All" && selectedDepart != "All"){
                         Get.toNamed(Routes.searchDemandsDataScreen, arguments: ['N', fromDate, toDate, deptCode, "-99", "-1", '98', '05']);
                       }
                       else {
                         AapoortiUtilities.showInSnackBar(context, "Please select required fields");
                       }
                     }
                     else if(selectedDemand == "Old CRIS MMIS" && _demandnumController.text.length == 0){
                       // if(fromDate != 'from' && toDate != 'to' && selectedstatus != "All" && selectedDepart != "All"){
                     ...
                     else if(selectedDemand == "New CRIS MMIS" && _demandnumController.text.length != 0){
                       Get.toNamed(Routes.searchDemandsDataScreen, arguments: ['N', "-1", "-1", "-1", "-1", _demandnumController.text.trim(), '98', '05']);
                     }
                     else if(selectedDemand == "Old CRIS MMIS" && _demandnumController.text.length != 0 && fromDate != '' && toDate != ''){
